 ...
 * @version $Id: customers.php for Amazon Pay V2 and COWOA 2023-04-08 19:56:51Z webchills $
 */
  ...
  switch ($action) {
    ...
    default:
      $customers = $db->Execute("SELECT c.customers_id, c.customers_gender, c.customers_firstname,
                                        ...
                                        c.COWOA_account, c.customers_authorization, c.customers_referral, c.customers_secret, c.customers_amazonpay_ec, c.customers_paypal_ec
