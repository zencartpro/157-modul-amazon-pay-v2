 ...
 * @version $Id: tpl_header.php for Amazon Pay V2 and COWOA 2023-11-17 17:13:58Z webchills $
 */
?>
...
<?php if ($_SESSION['cart']->count_contents() != 0) { ?>
  ...
  <?php if (isset($_SESSION['amazonpaylogin']) && $_SESSION['amazonpaylogin'] == true) {?>
  	<?php if (!in_array($current_page_base,explode(",",'checkout_shipping_amazon,checkout_payment_amazon,checkout_confirmation_amazon')) ) {?>
    	 <li><span class="amazon-pay-button" style="max-width:140px; margin-left:5px; vertical-align:top;"></span></li>
    	 <?php } ?>
    	 <?php } else { ?>
