 ...
 * @version $Id: amazon_pay_v2_login.php for COWOA 2023-04-02 12:59:16Z webchills $
 */
...
$sql = "SELECT * FROM " . TABLE_CUSTOMERS . " WHERE customers_email_address = :emailAddress AND COWOA_account != 1 ";
