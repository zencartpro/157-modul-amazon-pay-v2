 ...
 * @version $Id: tpl_header.php for Amazon Pay V2 2023-04-02 20:52:58Z webchills $
 */
?>
...
<?php if ($_SESSION['cart']->count_contents() != 0) { ?>
  ...
  <?php if (isset($_SESSION['amazonpaylogin']) && $_SESSION['amazonpaylogin'] == true) {?>
    	 <li><span class="amazon-pay-button" style="max-width:170px; margin-left:5px; vertical-align:top;"></span></li>
