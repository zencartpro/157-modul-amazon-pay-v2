...
<?php
  } else { // show normal checkout button
?>
...
/**
 * load the amazon pay button if enabled
 */
?> 
<?php if (isset($_SESSION['amazonpaylogin']) && $_SESSION['amazonpaylogin'] == true) {?>

<div class="amazon-pay-button-outer-container"><div class="amazon-pay-button" style="float:right; max-width:170px;"></div></div>

<?php    } else { ?>
<div class="amazon-pay-button-outer-container"><div class="amazon-login-button" style="float:right; max-width:170px;"></div></div>	
	<?php
      }
?>
