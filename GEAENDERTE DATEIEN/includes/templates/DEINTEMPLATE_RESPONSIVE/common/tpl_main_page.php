 ...
 * @version $Id: tpl_main_page.php for Amazon Pay V2 2023-03-21 08:53:16Z webchills $
 */
...
?>
<!--bof- Amazon Pay V2 -->
<?php if (defined('MODULE_PAYMENT_AMAZON_PAY_V2_STATUS') && MODULE_PAYMENT_AMAZON_PAY_V2_STATUS == 'True') {?>
<script>
<?php
include DIR_FS_CATALOG . 'includes/modules/payment/amazon_pay_v2/js/amazon-pay.js';
?>
</script>
<?php 
include DIR_FS_CATALOG.'includes/modules/payment/amazon_pay_v2/includes/amazon_pay_v2_actions.php';
?>
<?php
