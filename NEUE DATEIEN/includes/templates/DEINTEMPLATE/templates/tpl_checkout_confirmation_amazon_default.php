 ...
 * @version $Id: tpl_checkout_confirmation_amazon_default.php 2023-04-01 13:57:16Z webchills $
 */
...
<div id="conditionslaststep"><?php echo TEXT_ZUSATZ_SCHRITT3; ?></div>
...
<div class="buttonRow forward"><a href="javascript:console.log();" id="amz-change-payment" data-href=""><?php echo '' . zen_image_button(BUTTON_IMAGE_CHANGE_ADDRESS, BUTTON_CHANGE_ADDRESS_ALT) . ''; ?></a></div>
  ...
  <h4 id="checkoutConfirmDefaultPaymentTitle"><?php echo AMAZON_PAY_PAYMENT_DESCRIPTOR; ?></h4>
...
<?php
  echo zen_draw_form('checkout_confirmation_amazon', $form_action_url, 'post', 'id="checkout_confirmation_amazon" onsubmit="submitonce();"');
...
?>
<p align="center"><?php echo TEXT_CONDITIONS_ACCEPTED_IN_LAST_STEP; ?></p>
<div style="display:none;"><div id="amazon-pay-button-manual"></div></div>
<div class="buttonRow center confirm-order"><?php echo zen_image_submit(BUTTON_IMAGE_CONFIRM_ORDER, BUTTON_CONFIRM_ORDER_ALT, 'name="btn_submit" id="btn_submit"') ;?></div>
</form>
</div>