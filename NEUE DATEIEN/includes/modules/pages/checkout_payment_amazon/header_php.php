 ...
 * @version $Id: header_php.php 2023-11-15 20:00:16Z webchills $
 */

// This should be first line of the script:
$zco_notifier->notify('NOTIFY_HEADER_START_CHECKOUT_PAYMENT_AMAZON');
...
if (!empty($_SESSION['sendto'])) {
	global $db;
    $q  = $db->Execute("SELECT entry_postcode, entry_country_id FROM " . TABLE_ADDRESS_BOOK . " WHERE address_book_id = " . (int)$_SESSION['sendto']);
    if (!$q->EOF) {
        $_SESSION['amazon_pay_delivery_zip']     = $q->fields['entry_postcode'];
        $_SESSION['amazon_pay_delivery_country'] = $q->fields['entry_country_id'];
    }
}
